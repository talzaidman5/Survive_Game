...
public class Activity_Game extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0081R.layout.activity_game);
    ...
    private void findViews() {
        this.arrows = new ImageButton[]{(ImageButton) findViewById(C0081R.C0084id.game_BTN_left),
                (ImageButton) findViewById(C0081R.C0084id.game_BTN_right),
                (ImageButton) findViewById(C0081R.C0084id.game_BTN_up),
                (ImageButton) findViewById(C0081R.C0084id.game_BTN_down)};
}
}
